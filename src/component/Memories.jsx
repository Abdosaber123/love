...
()=>{setShowBtn(true)}
    ...
    <div className="flex justify-center">
              <Link to={"/love"} className={` transition-all duration-300 mt-5 bg-[#F4C3BD] px-16  py-3 ${showBtn? "translate-y-0 opacity-100" :"translate-y-16 opacity-0"}`} type="button"> ابدأ الرحلة </Link>
