  ...
  return (
    <div className="bg-[#FAA9BC] py-4 px-9">
      ...
      <div className="images">
        ...
        <div className="1 bg-white w-fit mx-auto rounded-xl flex flex-col  items-center mt-4">
          <img src={img5} className="w-[300px]" alt="" srcset="" />
          <p className="mt-3 text-pink-400 font-bold py-2 ">💖</p>
        </div>
        <div className="1 bg-white w-fit mx-auto rounded-xl flex flex-col  items-center mt-4">
          <img src={img6} className="w-[300px]" alt="" srcset="" />
          <p className="mt-3 text-pink-400 font-bold py-2 ">🫶🏻 💋</p>
        </div>
        <div className="1 bg-white w-fit mx-auto rounded-xl flex flex-col  items-center mt-4">
          <img src={img7} className="w-[300px]" alt="" srcset="" />
          <p className="mt-3 text-pink-400 font-bold py-2 ">❤️‍🔥</p>
        </div>
        <div className="1 bg-white w-fit mx-auto rounded-xl flex flex-col  items-center mt-4">
          <img src={img8} className="w-[300px]" alt="" srcset="" />
          <p className="mt-3 text-pink-400 font-bold py-2 ">🫶🏻 💕</p>
        </div>
        <div className="1 bg-white w-fit mx-auto rounded-xl flex flex-col  items-center mt-4">
